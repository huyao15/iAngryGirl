...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier rowAtIndexPath:(NSIndexPath *)indexPath withHeadView:(XLQHeadView *)headView{
    ...
    if (self) {
        UILabel *monthLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, 0, 30, self.frame.size.height)];
        ...
        UIView *moodView = [[UIView alloc]initWithFrame:CGRectMake(monthLabel.frame.size.width+monthLabel.frame.origin.x+10, 0, self.frame.size.width-(monthLabel.frame.size.width+monthLabel.frame.origin.x+10), self.frame.size.height)];
